...
const CustomCursor = () => {
  ...
  return (
    <>
      ...
      />
      <motion.div
        className="fixed top-0 left-0 w-10 h-10 border border-primary-500 rounded-full pointer-events-none z-[99] hidden md:block opacity-50 mix-blend-difference"
        animate={{
